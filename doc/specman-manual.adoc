...
image::goodmorning-screenshot.png[Good Morning Specman Diagramm, width=600]
...
image::goodmorning-screenshot-folded.png[Good Morning Specman Diagramm Folded, width=600]
