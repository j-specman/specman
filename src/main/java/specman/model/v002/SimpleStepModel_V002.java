...
public class SimpleStepModel_V002 extends AbstractStepModel_V002 {
    ...
    public SimpleStepModel_V002(String id, EditorContentModel_V002 content, int color, ChangeInfo changeInfo, String sourceStepId, RoundedBorderDecorationStyle decorationStyle) {
