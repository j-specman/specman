...
public class IfStepModel_V002 extends StructuredStepModel_V002 {
    ...
    public IfStepModel_V002(String id, EditorContentModel_V002 content, int color, RoundedBorderDecorationStyle decorationStyle, boolean collapsed, ChangeInfo changeInfo, BranchSequenceModel_V002 ifSequence, int emptyWidth, String sourceStepId) {
