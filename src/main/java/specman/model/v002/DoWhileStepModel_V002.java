...
public class DoWhileStepModel_V002 extends WhileStepModel_V002 {
    ...
    public DoWhileStepModel_V002(String id, EditorContentModel_V002 content, int color, ChangeInfo changeInfo, boolean collapsed, StepSequenceModel_V002 loopSequence, int barWidth, String sourceStepId, RoundedBorderDecorationStyle decorationStyle) {
